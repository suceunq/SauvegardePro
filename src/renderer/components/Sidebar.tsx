import { LayoutDashboard, ListChecks, PlusCircle, History, Settings } from 'lucide-react'
...
export default function Sidebar() {
  ...
  return (
    <aside className="flex w-60 shrink-0 flex-col border-r border-slate-800 bg-slate-950 text-slate-200">
      ...
      <div className="mt-auto px-5 py-4 text-xs text-slate-600">SauvegardePro v1.0.0</div>
    </aside>
  )
}
